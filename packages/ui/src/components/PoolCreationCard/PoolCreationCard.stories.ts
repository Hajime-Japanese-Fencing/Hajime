...
import PoolCreationCard from "./PoolCreationCard.vue";
...
const meta = {
  title: "Pool/PoolCreationCard",
  component: PoolCreationCard,
  tags: ["autodocs"],
  args: {
    poolDetails,
  },
} satisfies Meta<typeof PoolCreationCard>;
...
export const MultipleCards: Story = {
  render: () => ({
    components: { PoolCard: PoolCreationCard },
    setup() {
      const pools: Array<{ poolDetails: PoolDetails }> = [
        {
          poolDetails: {
            poolId: 1,
            fighters: [
